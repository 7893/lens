/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f04a0c456424248d765018280139a31a)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PHOTO_QUEUE: Queue;
		AI: Ai;
		PHOTO_WORKFLOW: Workflow<Parameters<import("./src/index").PicIngestWorkflow['run']>[0]['payload']>;
	}
}
